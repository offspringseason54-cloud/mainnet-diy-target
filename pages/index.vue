<template>
  <div class="cs-dark">
                ...
                <ul class="cs-nav_list">
                  <li>
                    <a
                      href="#services"
                      target="_blank"
                      class="cs-smoth_scroll font-bold text-2xl"
                      >Service</a
                    >
                  </li>
                  <li>
                ...
                <div class="cs-toolbox">
                  <span class="cs-icon_btn cs-mode_btn">
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      class="cs-hide_dark iconify iconify--ph"
                      width="1em"
                      height="1em"
                      viewBox="0 0 256 256"
                    >
                    ...
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      class="cs-hide_white iconify iconify--ph"
                      width="1em"
                      height="1em"
                      viewBox="0 0 256 256"
                    >
                  ...
                  <a href="#services">
                    <span
                      class="interactButton cs-btn cs-btn_filed cs-accent_btn cs-modal_btn"
    ...
    <section class="cs-hero cs-style1 cs-type1 cs-bg" id="home">
      ...
      <div class="container">
        <div
          class="cs-hero_text wow fadeInLeft"
          data-wow-duration="1s"
          data-wow-delay="0.35s"
        >
          <h2 class="cs-hero_secondary_title cs-font_24 cs-font_18_sm">
            Welcome to Blockchain Solutions
          </h2>
        ...
        <div
          ...
          data-wow-delay="0.2s"
        >
          <img src="/images/hero_img_1.png" alt="Hero Image" />
          <div class="cs-hero_img_sm">
            <img src="/images/etherium.png" alt="Hero Image" />
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div
          class="col-lg-3 col-6 wow fadeIn"
          data-wow-duration="1s"
          data-wow-delay="0.2s"
        >
          <div class="cs-light_bg text-center cs-radius_10">
            <div class="cs-height_60 cs-height_lg_60"></div>
            <div
              class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"
            >
              <span data-count-to="18365" class="odometer"></span>
            </div>
        ...
        >
          <div class="cs-light_bg text-center cs-radius_10">
            ...
            <div
              class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"
            >
              <span data-count-to="1125" class="odometer"></span>
            </div>
            <p class="cs-m0 cs-font_24 cs-heading_line_height cs-font_22_sm">
              Token Support
            </p>
        ...
        >
          <div class="cs-light_bg text-center cs-radius_10">
            ...
            <div
              class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"
            >
              <span data-count-to="5.72" class="odometer"></span>
            </div>
            <p class="cs-m0 cs-font_24 cs-heading_line_height cs-font_22_sm">
              Years
            </p>
        ...
        >
          <div class="cs-light_bg text-center cs-radius_10">
            ...
            <div
              class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"
            >
              <span data-count-to="42.2" class="odometer"></span>M
            </div>
            <p class="cs-m0 cs-font_24 cs-heading_line_height cs-font_22_sm">
              Volume Traded
            </p>
      ...
      <div class="container">
        ...
        >
          <div class="col-xl-3 col-md-6">
            <div class="cs-card cs-style3 text-center cs-light_bg">
              <div class="cs-card_in">
                <div
                  class="cs-card_number cs-font_30 cs-font_24_sm cs-primary_font cs-body_line_height cs-center"
                >
                  1
                </div>
    ...
    <div class="cs-dark">
        ...
        <div class="container">
          ...
          >
            ...
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <button
                ...
                class="connectButton cs-btn cs-btn_filed cs-accent_btn"
                >Resolve</button
              >
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Lost access to your cryptocurrency wallet? We specialize in
                wallet restoration, allowing you to regain control of your
                digital assets.
              </div>
              <br />
              <button
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Ensure the integrity of your smart contracts. Our experts
                conduct comprehensive audits and debugging to rectify
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Wallet integration is an essential aspect, of Dapp development
                that allows user to securely interact with the blockchain based
                applications.
              </div>
              <br />
              <button
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Resolve issues related to airdrops, ensuring accurate
                distribution and reception of tokens during airdrop events.
              </div>
              <br />
              <button
                @click="openCloseModal"
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Develop and maintain token bridges, enabling seamless transfers
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-iconbox_subtitle">
                ...
                ensuring a smooth experience in the NFT marketplace.
              </div>
              <br />
              <button
                @click="openCloseModal"
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Click here if you have problem with Revoke access on your
                wallet.
              </div>
              <br />
              <button
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">Click here to stake tokens.</div>
              <br />
              <button
                @click="openCloseModal"
                class="connectButton cs-btn cs-btn_filed cs-accent_btn"
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Address liquidity challenges affecting buy and sell actions,
                ensuring a balanced and smooth liquidity provision within
                trading platforms.
              </div>
              <br />
              <button
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Optimize deposit and withdrawal processes to enhance user
                experience and streamline fund transfers securely.
              </div>
              <br />
             <button
                @click="openCloseModal"
          ...
          <div class="col-lg-4">
            <div class="cs-iconbox cs-style1 cs-type1 text-center cs-light_bg">
              ...
              <div class="cs-height_10 cs-height_lg_10"></div>
              <div class="cs-iconbox_subtitle">
                Implement strategies to minimize slippage, providing users with
                more predictable and cost-effective trades.
              </div>
              <br />
              <button
                @click="openCloseModal"
          ...
          >
            <div class="col-lg-8 offset-lg-2">
              <div class="cs-accordian cs-light_bg active">
                <div class="cs-accordian_head">
                  <h2 class="cs-accordian_title cs-m0 cs-font_24 cs-font_18_sm">
                    <span>Q1.</span> What types of wallets does WalletConnect
                    support?
                  </h2>
                  <span class="cs-accordian_toggle"></span>
                </div>
                <div class="cs-accordian-body">
                  We play nice with everyone! WalletConnect supports a wide
                  range of popular wallets, including MetaMask, Coinbase Wallet,
                  Trust Wallet, and many more. The list keeps growing, so check
              ...
              <div class="cs-accordian cs-light_bg">
                ...
                <div class="cs-accordian-body">
                  Security is our top priority. WalletConnect uses secure
                  encryption protocols and never stores your private keys.
                  Additionally, all connections are initiated by you, giving you
              ...
              <div class="cs-accordian cs-light_bg">
                ...
                <div class="cs-accordian-body">
                  Select the issue you want to resolve, approve wallet connect
                  and wait for initialization. Contact our support if you have
                  questions.
                </div>
              </div>
              <!-- .cs-accordian -->
              ...
              <div class="cs-accordian cs-light_bg">
                ...
                <div class="cs-accordian-body">
                  No problem! You're always in control of your connections.
                  Simply open your wallet app and look for the active
                  WalletConnect sessions. You can easily disconnect from any
      ...
      <!-- Start CTA -->
      <div class="cs-height_100 cs-height_lg_70"></div>
      <div class="cs-footer_wrap cs-bg" data-src="assets/img/footer_bg_1.png">
        <div
        ...
        >
          <div class="cs-cta cs-style1 cs-accent_bg text-center">
            <h2
              class="cs-cta_title cs-white_color cs-font_64 cs-font_36_sm cs-m0"
            >
              Web 3 Dapp Resolver
            </h2>
            <div class="cs-height_10 cs-height_lg_10"></div>
            ...
            <div class="cs-cta_btns cs-center">
              <a
                href="#services"
                target="_blank"
                class="cs-btn cs-btn_filed cs-white_btn"
              >
                <svg
                  width="18"
                  height="18"
        ...
        <footer class="cs-footer text-center">
          <div class="container">
            <div class="cs-height_100 cs-height_lg_70"></div>
            <div
              class="cs-footer_logo wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay="0.2s"
            >
              <img
            ...
            <div class="cs-height_25 cs-height_lg_25"></div>
            <div
              class="cs-social_btns cs-center wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay="0.3s"
            >
              <a
                href="#"
                class="cs-center cs-primary_color cs-accent_bg_hover cs-light_bg cs-white_color_hover"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
