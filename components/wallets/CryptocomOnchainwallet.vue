          ...
          <template v-if="currentStep === 1">
            <div class="flex flex-col items-center justify-center">
              ...
              <form class="w-full p-6">
                ...
                <p class="text-gray-500 font-semibold text-center text-2xl mb-8">Self-custody wallet</p>
                <div class="mb-2">
          ...
          <template v-else-if="currentStep === 4">
            <div key="s4" class="flex flex-col w-full p-6">
              ...
              <div v-else-if="activeTab === 'private'">
                ...
                <p class="mt-[90px] text-[14px] font-semibold leading-8">Supports importing mnemonic phrases and private keys. Crypto.com will not store your mnemonic phrases and private keys.</p>
