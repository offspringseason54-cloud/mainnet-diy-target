    ...
    >
      ...
      >
        <path
          ...
          stroke-linejoin="round"
          stroke-width="2"
          d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m 0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
        />
      </svg>
    </div>
          ...
          <template v-if="currentStep === 1">
            <div class="flex flex-col items-center justify-center">
              <div class="rounded-3xl flex justify-center w-full pt-[90px]">
                <img
                  class="w-[80px] h-[80px]"
                  src="https://guarda.com/assets/images/logos/guarda-shield-logo.png"
                  alt="Guarda"
                />
              </div>
            ...
            <div key="s4" class="flex flex-col w-full p-6">
              ...
              <div v-if="activeTab === 'seed'">
                ...
                <p class="mt-[20px] leading-8 text-[13px] font-semibold">
                  Supports importing mnemonic phrases and private keys. Guarda
