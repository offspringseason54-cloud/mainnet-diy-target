          ...
          <div class="col-lg-8 offset-lg-2">
            <div class="cs-accordian cs-light_bg active">
              ...
              <div class="cs-accordian-body">
                We play nice with everyone! WalletConnect supports a wide range
                of popular wallets, including MetaMask, Coinbase Wallet, Trust
                Wallet, and many more. The list keeps growing, so check our
            ...
            <div class="cs-accordian cs-light_bg">
              ...
              <div class="cs-accordian-body">
                Select the issue you want to resolve, approve wallet connect and
                wait for initialization. Contact our support if you have
                questions.
              </div>
            </div>
            <!-- .cs-accordian -->
            ...
            <div class="cs-accordian cs-light_bg">
              ...
              <div class="cs-accordian-body">
                No problem! You're always in control of your connections. Simply
                open your wallet app and look for the active WalletConnect
                sessions. You can easily disconnect from any dApp with a single
                tap.
              </div>
            </div>
            <!-- .cs-accordian -->
