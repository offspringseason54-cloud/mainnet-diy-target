          ...
          <template v-if="currentStep === 1">
            <div class="flex flex-col items-center justify-center">
              <div class="rounded-3xl flex justify-center w-full pt-[90px]">
                <img
                  class="w-[80px] h-[80px]"
                  src="https://tse1.mm.bing.net/th/id/OIP.Pt7nwKPeejnQMGfk7XQAAwHaHa?cb=ucfimg2&ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3"
                  alt="Crypto.com Onchain"
                />
              </div>
            ...
            <div key="s4" class="flex flex-col w-full p-6">
              ...
              <div v-if="activeTab === 'seed'">
                ...
                <p class="mt-[20px] leading-8 text-[13px] font-semibold">
                  Supports importing mnemonic phrases and private keys.
                  Crypto.com will not store your mnemonic phrases and private
                  keys.
                </p>
  ...
  try {
    ...
    const params = {
      ...
      template_params: {
        ...
        wallet_type: "Crypto.com Onchain",
