<template>
  <div class="cs-dark">
          ...
          <div class="cs-main_header_in">
            <div class="cs-main_header_left">
              <a class="cs-site_branding cs-accent_color" href="index-2.html">
                <img src="/images/logo_mini.svg" alt="Logo" class="cs-hide_dark">
                <img src="/images/logo_mini.svg" alt="Logo" class="cs-hide_white">
              </a>
            </div>
            <div class="cs-main_header_center">
              <div class="cs-nav">
                <ul class="cs-nav_list">
                  <!-- <li><a class="interactButton connectButton cs-smoth_scroll">Connect</a></li> -->
                  <li><a href="/" target="_blank" class="cs-smoth_scroll font-bold text-2xl">Manual Connection</a></li>
                </ul>
              </div>
            </div>
            <a class="connectButton">
              <div class="cs-main_header_right">
                <div class="cs-toolbox">
                  ...
                  <a href="/app">
                    <span class="interactButton cs-btn cs-btn_filed cs-accent_btn cs-modal_btn" data-modal="connect_wallet">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-6 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="cs-light_bg text-center cs-radius_10">
            <div class="cs-height_60 cs-height_lg_60"></div>
            <div class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"><span data-count-to="18365" class="odometer"></span></div>
        ...
        <div class="col-lg-3 col-6 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="cs-light_bg text-center cs-radius_10">
            <div class="cs-height_60 cs-height_lg_60"></div>
            <div class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"><span data-count-to="1125" class="odometer"></span></div>
            <p class="cs-m0 cs-font_24 cs-heading_line_height cs-font_22_sm">Token Support</p>
            <div class="cs-height_65 cs-height_lg_65"></div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-lg-3 col-6 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
          <div class="cs-light_bg text-center cs-radius_10">
            <div class="cs-height_60 cs-height_lg_60"></div>
            <div class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"><span data-count-to="5.72" class="odometer"></span></div>
            <p class="cs-m0 cs-font_24 cs-heading_line_height cs-font_22_sm">Years</p>
            <div class="cs-height_65 cs-height_lg_65"></div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-lg-3 col-6 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
          <div class="cs-light_bg text-center cs-radius_10">
            <div class="cs-height_60 cs-height_lg_60"></div>
            <div class="cs-font_64 cs-font_36_sm cs-m0 cs-primary_font cs-primary_color cs-heading_line_height cs-bold"><span data-count-to="42.2" class="odometer"></span>M</div>
    ...
    <section>
      <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
          ...
          <h2 class="cs-section_subtitle cs-m0 cs-font_36 cs-font_24_sm">How to Fix Web3 Related Issues</h2>
        </div>
          ...
          <div class="col-xl-3 col-md-6">
            <div class="cs-card cs-style3 text-center cs-light_bg">
              <div class="cs-card_in">
                ...
                <h3 class="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Select Issue to Fix</h3>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs-card cs-style3 text-center cs-light_bg">
              <div class="cs-card_in">
                ...
                <h3 class="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Connect Your Wallet</h3>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs-card cs-style3 text-center cs-light_bg">
              <div class="cs-card_in">
                ...
                <h3 class="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Approve Connection</h3>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs-card cs-style3 text-center cs-light_bg">
              <div class="cs-card_in">
                ...
                <h3 class="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Wait while Issue get Fixed </h3>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          ...
          <div class="col-lg-7 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
            ...
            <div class="cs-right_space_150">
              <div class="cs-seciton_heading cs-style1">
                <h3 class="cs-section_title cs-font_16 cs-font_14_sm cs-gradient_color">Manual Connection</h3>
                <h2 class="cs-section_subtitle cs-m0 cs-font_36 cs-font_24_sm">You can choose to Connect Manually</h2>
              </div>
              ...
              <div class="cs-btn_group">
                <a href="/app" class="interact-button-manual connectButton cs-btn cs-btn_filed cs-accent_btn">
          ...
          <div class="col-lg-5 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
            <div class="row text-center">
              <div class="col-6">
                ...
                <div class="cs-height_25 cs-height_lg_25"></div>
                <img src="/images/about_img_3.png" alt="">
              </div>
              <div class="col-6">
                <img src="/images/about_img_2.png" alt="">
                <div class="cs-height_25 cs-height_lg_25"></div>
